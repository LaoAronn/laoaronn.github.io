...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/aronn-laurel/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      href: 'https://www.instagram.com/aronn1of1/',
  ...
  return (
    <section id="contact" className="section">
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="items-center justify-center mb-12 lg:mb-0 lg:flex lg:flex-col ">
          <h2 className="headline-2 lg:max-w-[12ch] reveal-up">
            Contact me for Collaboration!
          </h2>

          <p className=" text-zinc-400 mt-3 mb-8 reveal-up">
            Let’s connect and see how we can create something meaningful together!
          </p>

          <div className="flex sm:justify-center gap-2 mt-auto">
        ...
        <form action="https://getform.io/f/bqokggob" method="POST" className="xl:pl-10 2xl:pl-20">
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input type="email" name="email" id="email"
                    autoComplete="email" required placeholder="aronn@example.com" 
                    className="text-field reveal-up"
              />
            </div>
          ...
          <button type="submit" className="btn-submit btn-primary [&]:max-w-full w-full justify-center reveal-up">
            Submit
          </button>
