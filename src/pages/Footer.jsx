...
const Footer = () => {
  ...
  return (
    <footer className="py-16 lg:py-20 text-[var(--text)] transition-colors duration-300">
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="text-sm text-[var(--text)]/80 flex items-center gap-2 transition-colors duration-300">
              {isDaytime ? (
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <div className="flex flex-col items-start md:items-end gap-2">
              ...
              <p className="text-sm text-[var(--text)]/80 transition-colors duration-300">Want to collaborate? HMU</p>
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-[var(--text)]/70 gap-4 transition-colors duration-300">
