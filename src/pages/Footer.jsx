...
const Footer = () => {
  ...
  return (
    <footer className="py-16 lg:py-20">
      ...
      {/* Divider */}
      <div className="w-full h-px bg-gradient-to-r from-zinc-700/0 via-zinc-700/50 to-zinc-700/0 mb-8"></div>
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col items-start gap-4">
            <a href="/" className="flex items-center gap-2">
              <img 
                ...
                alt="Logo"
              />
              <span className="text-2xl font-bold text-white"> Aronn Laurel </span>
            </a>

            <p className="text-sm text-gray-400 flex items-center gap-2">
              {isDaytime ? (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-9v2.25m-6.364.386l1.591 1.591M9 12a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              ) : (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-4 h-4">
          ...
          <div className="flex flex-col items-start md:items-center gap-4">
            <nav className="flex flex-col md:flex-row gap-6 text-sm text-gray-400">
              <Link to="/" className="hover:text-white transition-colors">Project</Link>
              <Link to="/works" className="hover:text-white transition-colors">Work</Link>
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <div className="flex flex-col items-start md:items-end gap-2">
              ...
              <p className="text-sm text-gray-400">Want to collaborate? HMU</p>
