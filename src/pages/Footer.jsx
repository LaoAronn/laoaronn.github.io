...
const Footer = () => {
  ...
  return (
    <footer className="py-16 lg:py-20 text-zinc-900 dark:text-zinc-50 transition-colors duration-300">
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <p className="text-sm text-[#3f3f46] dark:text-zinc-400 flex items-center gap-2 transition-colors duration-300">
              {isDaytime ? (
          ...
          <div className="flex flex-col items-start md:items-center gap-4">
            <nav className="flex flex-col md:flex-row gap-6 text-sm text-[#3f3f46] dark:text-zinc-400 transition-colors duration-300">
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <div className="flex flex-col items-start md:items-end gap-2">
              ...
              <p className="text-sm text-[#3f3f46] dark:text-zinc-400 transition-colors duration-300">Want to collaborate? HMU</p>

              {/* Socials */}
              <div className="flex gap-4 mt-2">
                
                <a href="https://www.instagram.com/aronn1of1/" target="_blank" rel="noopener noreferrer" 
                  className="text-[#3f3f46] dark:text-zinc-400 hover:text-[#18181b] dark:hover:text-zinc-50 transition-colors">
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-[#52525b] dark:text-zinc-400 gap-4 transition-colors duration-300">
