      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="flex flex-col items-start gap-4">
            <a href="/" className="flex items-center gap-2">
              <img 
                ...
                alt="Logo"
              />
              <span className="text-2xl font-bold text-zinc-900 dark:text-white transition-colors duration-300"> Aronn Laurel </span>
            </a>

            <p className="text-sm text-zinc-600 dark:text-gray-400 flex items-center gap-2 transition-colors duration-300">
              {isDaytime ? (
          ...
          <div className="flex flex-col items-start md:items-center gap-4">
            <nav className="flex flex-col md:flex-row gap-6 text-sm text-zinc-600 dark:text-gray-400 transition-colors duration-300">
              <Link to="/" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Project</Link>
              <Link to="/works" className="hover:text-zinc-900 dark:hover:text-white transition-colors">Work</Link>
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <div className="flex flex-col items-start md:items-end gap-2">
              ...
              <p className="text-sm text-zinc-600 dark:text-gray-400 transition-colors duration-300">Want to collaborate? HMU</p>
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-zinc-500 dark:text-gray-500 gap-4 transition-colors duration-300">
