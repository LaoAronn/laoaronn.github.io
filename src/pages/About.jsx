        ...
        <section id="home" className="py-8 lg:py-16 px-4 sm:px-6">
            ...
            <div className="container flex flex-col items-center max-w-2xl mx-auto">
                ...
                <div className="flex flex-col items-center w-full gap-6 lg:gap-8">
                    ...
                    <div className="flex flex-col items-start gap-3 sm:gap-4 text-sm sm:text-base tracking-[0.005em] text-gray-400 w-full">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs sm:text-sm">Statistics B.S. / University of British Columbia</span>
                        </div>
                    ...
                    <p className="text-zinc-300 text-left text-sm sm:text-base lg:text-lg leading-relaxed w-full">
