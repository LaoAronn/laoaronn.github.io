...
const ProjectCard = ({ title, desc, tags, icon, color, link }) => {
  ...
  return (
    <a
      ...
      className="project-card group flex flex-col overflow-hidden rounded-xl border-2 transition-all duration-300 hover:-translate-y-1"
      style={{ backgroundColor: hex }}
    >
      {/* icon */}
      <div className="project-card-divider border-b-2">
