      ...
      >
        ...
        <div className="mt-4 flex items-center justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full bg-sky-400 hover:bg-sky-500 text-black text-sm font-semibold transition-colors shadow-lg"
          >
